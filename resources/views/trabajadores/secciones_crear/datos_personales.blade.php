    ...
    <div class="card-body">
        ...
        <div class="row">
            <div class="col-md-4 mb-3">
                ...
                <input type="text" class="form-control @error('nombre_trabajador') is-invalid @enderror"
                       id="nombre_trabajador" name="nombre_trabajador"
                       value="{{ old('nombre_trabajador') }}"
                       placeholder="Nombre completo" style="text-transform: uppercase" required>
        ...
        <div class="row">
            <div class="col-md-4 mb-3">
                ...
                <input type="text" class="form-control formato-fecha @error('fecha_nacimiento') is-invalid @enderror"
            ...
            <div class="col-md-4 mb-3">
                ...
                <input type="text" class="form-control @error('curp') is-invalid @enderror"
                       id="curp" name="curp"
                       value="{{ old('curp') }}"
                       placeholder="18 caracteres" maxlength="18" style="text-transform: uppercase" required>
        ...
        <div class="row">
            <div class="col-md-4 mb-3">
                ...
                <input type="text" class="form-control @error('rfc') is-invalid @enderror"
                       id="rfc" name="rfc"
                       value="{{ old('rfc') }}"
                       placeholder="13 caracteres" maxlength="13" pattern="[A-Z0-9]{13}"
                       style="text-transform: uppercase" required>
            ...
            <div class="col-md-4 mb-3">
                ...
                <input type="text" class="form-control @error('no_nss') is-invalid @enderror"
                       id="no_nss" name="no_nss"
                       value="{{ old('no_nss') }}"
                       placeholder="Número de Seguro Social" maxlength="11">
            ...
            <div class="col-md-4 mb-3">
                ...
                <input type="tel" class="form-control @error('telefono') is-invalid @enderror"
                       ...
                       value="{{ old('telefono') }}"
                       placeholder="9931234567" maxlength="10" pattern="[0-9]{10}" required>
                @error('telefono')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
        ...
        <!-- Correo, Lugar de Nacimiento, Fecha de Ingreso -->
        <div class="row">
            <div class="col-md-4 mb-3">
                ...
                <input type="email" class="form-control @error('correo') is-invalid @enderror"
                       ...
                       value="{{ old('correo') }}" placeholder="ejemplo@email.com">
                @error('correo')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="col-md-4 mb-3">
                ...
                <input type="text" class="form-control @error('lugar_nacimiento') is-invalid @enderror"
                       ...
                       placeholder="Ciudad, Estado" maxlength="100" style="text-transform: uppercase">
            ...
            <div class="col-md-4 mb-3">
                ...
                <input type="text" class="form-control formato-fecha @error('fecha_ingreso') is-invalid @enderror"
        ...
        <div class="row">
            <div class="col-md-4 mb-3">
                ...
                <input type="text" class="form-control @error('direccion') is-invalid @enderror"
                       ...
                       value="{{ old('direccion') }}"
                       placeholder="Calle, número, colonia" style="text-transform: uppercase">
            ...
            <div class="col-md-4 mb-3">
                ...
                <input type="text" class="form-control @error('estado_actual') is-invalid @enderror"
                       id="estado_actual" name="estado_actual"
                       value="{{ old('estado_actual') }}"
                       placeholder="Ej: Tabasco" maxlength="50" style="text-transform: uppercase">
            ...
            <div class="col-md-4 mb-3">
                ...
                <input type="text" class="form-control @error('ciudad_actual') is-invalid @enderror"
                       id="ciudad_actual" name="ciudad_actual"
                       value="{{ old('ciudad_actual') }}"
                       placeholder="Ej: Villahermosa" maxlength="50" style="text-transform: uppercase">
                <div class="form-text">Ciudad donde reside</div>
                @error('ciudad_actual')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
        ...
        <div class="row">
            <div class="col-md-4 mb-3">
                ...
                <input type="text" class="form-control @error('codigo_postal') is-invalid @enderror"
                       ...
                       maxlength="5" pattern="[0-9]{5}" placeholder="86000" required>
