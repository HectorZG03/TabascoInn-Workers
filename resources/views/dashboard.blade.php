...
<div class="dashboard-container">
    ...
    <div class="functions-grid">
        ...
        @if (Auth::user()->tienePermiso('vacaciones', 'ver'))
            <div class="function-card" data-category="vacaciones">
                <div class="card-accent accent-vacation"></div>
                <div class="card-content">
                    <div class="card-icon icon-vacation">
                        <i class="bi bi-calendar-check-fill"></i>
                    </div>
                    <h3 class="card-title">Trabajadores con Vacaciones</h3>
                    <p class="card-description">Gestión y seguimiento de vacaciones del personal</p>
                    <a href="{{ route('trabajadores.vacaciones.lista') }}" class="btn-vacation">
                        <span>Ver lista</span>
                        <i class="bi bi-arrow-right"></i>
                    </a>
                </div>
