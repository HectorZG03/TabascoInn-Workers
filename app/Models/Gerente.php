...
class Gerente extends Model
{
    ...
    /**
     * ✅ NUEVO: Obtener el gerente de Recursos Humanos activo
     */
    public static function getRecursosHumanos()
    {
        return self::activos()
            ->where('cargo', 'Recursos Humanos')
            ->first();
    }
    ...
    /**
     * ✅ NUEVO: Verificar si es gerente de recursos humanos
     */
    public function esRecursosHumanos()
    {
        return $this->cargo === 'Recursos Humanos';
    }
}