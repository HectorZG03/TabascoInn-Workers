...
class TrabajadoresCumpleañosExport implements FromCollection, WithHeadings, WithMapping, ShouldAutoSize, WithStyles, WithTitle
{
    ...
    {
        // Estilo para el título principal - Verde Olivo
        ...
        $sheet->getStyle('A1')->applyFromArray([
            ...
            'fill' => [
                ...
                'startColor' => ['rgb' => '9CAF88'] // Verde olivo principal
            ],
            'alignment' => [
        ...
        // Estilo para encabezados de columna - Verde Olivo más claro
        $sheet->getStyle('A4:J4')->applyFromArray([
            ...
            'fill' => [
                'fillType' => Fill::FILL_SOLID,
                'startColor' => ['rgb' => 'A8C090'] // Verde olivo claro para headers
            ],
            'borders' => [
                'allBorders' => [
