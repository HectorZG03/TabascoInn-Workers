...
class PlantillaContratoController extends Controller
{
    ...
    private function obtenerTrabajadorEjemplo()
    {
        ...
        // ✅ CREAR CATEGORÍA DE EJEMPLO - ACTUALIZADA CON DESCRIPCIÓN DE FUNCIONES
        $categoria = (object) [
            'nombre_categoria' => 'RECEPCIONISTA',
            'descripcion_funciones' => 'Atención al cliente y huéspedes, registro de entradas y salidas, manejo del sistema de reservaciones, atención telefónica, control de correspondencia, apoyo administrativo general, elaboración de reportes diarios, coordinación con otras áreas del hotel, manejo de caja chica y facturación'
        ];
